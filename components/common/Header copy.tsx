...
export default function Header() {
  ...
  return (
    ...
    <header className="ds-header">
      ...
      <div className="ds-header__topbar">
        <div className="ds-container ds-header__topbar-inner">
          <div className="ds-header__hotline">
            {t('contactHpTitle')} : <strong>1644-6223</strong> / <strong>14-3330</strong>
          </div>
      ...
      <AntHeader className="ds-header__main" style={{ padding: 0 }}>
        <div className="ds-container ds-header__main-inner">
          <div className="ds-header__brand">
            <Link to="/" className="ds-header__logo" aria-label="한국의약품안전관리원 홈">
              <span className="ds-header__logo-mark">KIDS</span>
              <span className="ds-header__logo-text">한국의약품안전관리원</span>
            </Link>
          </div>

          <nav className="ds-header__nav" aria-label="주요 메뉴">
            <Menu mode="horizontal" items={menuItems2} selectable={false} />
          </nav>
          ...
          <div className="ds-header__search">
            <Input
              ...
              onPressEnter={() => navigate(`/search?q=${encodeURIComponent(keyword)}`)}
            />
          </div>
        </div>
